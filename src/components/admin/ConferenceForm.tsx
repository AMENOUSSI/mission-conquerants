...
export function ConferenceForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      ...
      <div className="grid gap-2">
        <Label htmlFor="videoUrl">Lien vidéo (YouTube ou Vimeo)</Label>
        <Input
          id="videoUrl"
          name="videoUrl"
          type="url"
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="grid gap-2">
          <Label htmlFor="eventDate">Date de la conférence (facultatif)</Label>
          <Input
            id="eventDate"
            name="eventDate"
            type="date"
            defaultValue={toLocalDateValue(initialValues?.eventDate)}
          />
        </div>
        <div className="grid gap-2">
